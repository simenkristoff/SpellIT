...
public class Scoreboard extends AnchorPane implements NextTurnListener {

	private final Game game;
	private final Player player1, player2;
	private final Text player1Score, player2Score;
	...
	public void onNextTurn() {
		// tilesLeft.setText(String.valueOf(game.letterCollection.remainingLetters()));
	}
}
